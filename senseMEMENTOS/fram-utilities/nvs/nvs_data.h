...
//
//******************************************************************************
extern nvs_status nvs_data_restore(nvs_data_handle handle, void *data, int ctpl_magic_number,int whichBox);
...
//
//******************************************************************************
extern nvs_status nvs_data_commit(nvs_data_handle handle, void *data,int whichBox);
