...
nvs_status nvs_data_restore(nvs_data_handle handle, void *data, int ctpl_magic_number)
{
    uint16_t crc;
    uint8_t *data1;
    uint8_t *data2;
...
nvs_status nvs_data_commit(nvs_data_handle handle, void *data, int ctpl_magic_number)
{
    uint8_t *data1;
    uint8_t *data2;
    uint16_t framState;
