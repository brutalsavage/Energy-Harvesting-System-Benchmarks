...
nvs_data_handle nvs_data_init2(uint8_t *storage, uint16_t size)
{
    uint8_t *data1;
    uint8_t *data2;
    uint16_t crc;
...
nvs_status nvs_data_restore2(nvs_data_handle handle, void *data)
{
    uint16_t crc;
    uint8_t *data1;
    uint8_t *data2;
...
nvs_status nvs_data_commit2(nvs_data_handle handle, void *data)
{
    uint8_t *data1;
    uint8_t *data2;
    uint16_t framState;
